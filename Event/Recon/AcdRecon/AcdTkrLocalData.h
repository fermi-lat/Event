...
*  \author Eric Charles
*
* $Header: /nfs/slac/g/glast/ground/cvs/Event/Event/Recon/AcdRecon/AcdTkrLocalCoords.h,v 1.2 2005/11/09 01:11:09 heather Exp $
*/
...
namespace Event
{
  ...
  public:
    ...
    AcdTkrLocalCoords(const float localPosition[2], float pathLength, float cosTheta, 
		      int region, const HepMatrix& localCovMatrix);
